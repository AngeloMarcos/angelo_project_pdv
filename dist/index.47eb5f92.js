...
document.querySelector(".product__btn-submit").addEventListener("click", function(event) {
    ...
    const product = new (0, _productJsDefault.default)(name, category, quantity, costPrice, salePrice, supplier, entryDate);
...
class Product {
    constructor(name, category, quantity, costPrice, salePrice, supplier, entryDate){
        this.name = name;
...
},{}],"8wqcO":[function(require,module,exports) {
